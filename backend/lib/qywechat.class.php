...
<Nonce><![CDATA[%s]]></Nonce>
	 ...
	 * }
	 * @internal param 媒体文件类型 $type :图片（image）、语音（voice）、视频（video），普通文件(file)
	 */
	 ...
	 * @param int|跳转链接时所在的企业应用ID $agentid 跳转链接时所在的企业应用ID，未填则默认为当前配置的应用id
	 ...
	 * @param string|推送到微信上的提示语 $invite_tips 推送到微信上的提示语（只有认证号可以使用）。当使用微信推送时，该字段默认为“请关注XXX企业号”，邮件邀请时，该字段无效。
	 * @return array|bool 成功返回数组
	 * array(
	 * 'errcode' => 0,
	 * 'errmsg' => 'ok',
